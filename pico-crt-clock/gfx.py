...
Font: ZX Spectrum 48K charset, 8x8 px per glyph (MSB = leftmost pixel).

Requires: pip install pygame
Run via:  cd pico-crt-clock && python run_sim.py
"""
...
def _ensure_init():
    ...
    pygame.display.set_caption("pico-crt-clock sim")
